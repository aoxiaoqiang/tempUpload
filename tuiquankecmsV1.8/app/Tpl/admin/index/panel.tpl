...
<div class="pad_10">
	<div class="clearfix">
		...
		<div class="col-2 col-auto">
				<h6>授权信息</h6>
			<div class="content" style="height:80px;">
				授权类型：<span><font color="green">VIP版</font></span><br />
				授权域名：<span><font color="green">http://bbs.sasadown.cn</font></span><br />
				<div class="bk20 hr"><hr /></div>
		...
		<div class="col-2 fl mr10" style="width:48%">
			...
			<div class="content" style="height:113px;">
				{:L('yhxia_version')}： [最新版本]<!--<span style="color: #260BEE;font-weight: bold;" id="new_version">6.0</span><span id="version_update">[在线升级]</span>--><br />
