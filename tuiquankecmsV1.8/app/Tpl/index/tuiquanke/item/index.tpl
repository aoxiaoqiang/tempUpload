										...
										<div class="pic">
											<if condition="$item.class eq 'tag_wait' ">
												<a href="javascript:void()">
													<else />
													<a isconvert="1" data-itemid="{$item.num_iid}"  href="{$item.item_url}"  target="_blank" title="{$item.title}">
											</if>
											...
											<div class="buy-step clearfix">
												...
												<if condition="$item.isq eq '1'">
													<div class="buy-step-first">
														...
														<a rel="nofollow" class="coupon-btn" <if condition="$item['que'] eq 1 || $item['tk'] eq 0">  href="{:U('/out/action/quan/',array('id'=>$item['id']))}" target="_blank" <else/> id="coupon" href="javascript:;" </if> title="领券后请点击右边按钮下单" _hover-ignore="1">点击领取</a>
													</div>
												...
												<div id="code" class="code" <if condition="$item['tk'] eq 0 || $item['que'] eq 1 ">style="display: block;"<else/>style="display: none;"</if>>
													<p>手机淘宝扫码领券购买<img src="__STATIC__/tuiquanke/images/code.jpg" width="20" height="20"></p>
													<img id="codeimg" src="/?m=item&a=qrcode&dataurl={:urlencode($item['quanurl'])}" width="120" height="120">
												</div>
											</div>
