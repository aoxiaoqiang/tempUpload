			...
			<div class="sort">
				<div class="am-g">
					<div class="am-u-sm-4 am-text-center">
						...
						<label for="syn"><a href="{:U("list/index",array('sort'=>'new','cid'=>$cid))}">综合排序</a></label>
					</div>
					<div class="am-u-sm-4 am-text-center">
						<input type="radio" id="hots" name="sort" value="" class="am-hide"  <if condition='$txt_sort eq "hot"'> checked="checked"</if> />
						<label id="btn_hot" for="sale"><a href="{:U("list/index",array('sort'=>'hot','cid'=>$cid))}">销量排序</a></label>
					</div>
					<div class="am-u-sm-4 am-text-center">
						<input type="radio" id="rates" name="sort" value="" class="am-hide" <if condition='$txt_sort eq "rate"'> checked="checked"</if> />
					<label id="btn_rate" for="money"><a href="{:U("list/index",array('sort'=>'rate','cid'=>$cid))}">优惠金额</a></label>
					</div>
				</div>
